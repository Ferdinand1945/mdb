    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
      <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" data-intro="&lt;b&gt;Topbar&lt;/b&gt; has other styles with live demo. Go to &lt;b&gt;Layouts-&gt;Header&amp;Topbar&lt;/b&gt; and check it out." class="navbar navbar-default navbar-static-top">
        <div class="navbar-header">
          ...
          <a id="logo" href="index.php" class="navbar-brand"><span class="logo-text">µAdmin</span><span><img src="images/ald-logo.png"></span></a></div>
...
--> <div class="nav navbar navbar-top-links navbar-left mbn pull-down"> <h3 style="float: left; margin-left: 90px;">Master dashbord</h3></div>

          <ul class="nav navbar navbar-top-links navbar-right mbn pull-down">
...
<div class="icon-bg bg-orange"></div>
            ...
            <li><a href=""><i class="fa fa-th-list fa-fw">
              ...
              </i><span class="menu-title">Kredit</span><span class="fa arrow"></span></a>
              <ul class="nav nav-first-level collapse out">
                <li class="dropdown"><a href="creditcheck.php"><i class="fa fa-edit fa-fw">
                  <div class="icon-bg bg-orange"></div>
...
-->
                ...
                <li class=""><a href="log.php"><i class="fa fa-sitemap fa-fw">
                  <div class="icon-bg bg-red"></div>
                  </i><span class="menu-title">System Logg</span><span class="fa arrow"></span>
                  </a>
                </li>
